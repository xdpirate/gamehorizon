            ...
            if($output == "Already up to date.") {
                ...
                print("
                    <div>
                        ...
                        <a href='https://github.com/xdpirate/gamehorizon/commits/main' target='_blank'>See commit history</a> (opens in a new tab), or <input type='button' value='Return to GameHorizon' onclick='window.location.href=\".\";'>
                    </div>
                ");
            }
        }
